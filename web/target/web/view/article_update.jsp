            ...
            <form class="layui-form" action="/Article/update" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="title" value="${art.title}"  placeholder="" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 200px">
                        <select name="columnsid">
                            <c:forEach items="${column}" var="col">
                                <option ${art.columnsid == col.key.id?'selected':''}  value="${col.key.id}">${col.key.name}</option>
                                <c:forEach items="${col.value}" var="colu">
                                    <option ${art.columnsid == colu.id?'selected':''} value="${colu.id}">&nbsp;&nbsp;&nbsp;${colu.name}</option>
                                </c:forEach>
                            </c:forEach>
                        </select>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="width:1000px;">
                       <textarea id="content12" name="content" style="display: none;">${art.content}</textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">是否置顶</label>
                    <div class="layui-input-block">
                        <input type="checkbox" ${art.topping==1?'checked':''} value="1" name="topping" lay-text="开启|关闭" lay-skin="switch">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">是否显示</label>
                    <div class="layui-input-block">
                        <input type="checkbox" ${art.dispaly==1?'checked':''} value="1" name="dispaly" lay-text="开启|关闭" checked lay-skin="switch">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
