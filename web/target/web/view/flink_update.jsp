    ...
    <div class="main" id="app">
        ...
        <div class="right">
            ...
            <form class="layui-form " action="/link/add">
                <input name="id" type="hidden" value="${links.id}">
                <div class="layui-form-item">
                    <label class="layui-form-label">友情名称</label>
                    <div class="layui-input-block">
                        <input type="text" name="name" value="${links.name}"  placeholder="" autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="url"  value="${links.url}" placeholder="" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="desc"  placeholder="" value="${links.desc}" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">联系人</label>
                    <div class="layui-input-block">
                        <input type="text" value="${links.contactperson}" name="contactperson"  placeholder="" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">联系QQ</label>
                    <div class="layui-input-block">
                        <input type="text" name="qq"  value="${links.qq}" placeholder="" autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="checkbox" value="1" name="dispaly" lay-text="开启|关闭" ${links.dispaly==1?'checked':''}  lay-skin="switch">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
