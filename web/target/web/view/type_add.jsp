...
<div id="app">
    ...
    <div class="main" id="app">
        ...
        <div class="right">
            ...
            <form class="layui-form " action="/Columns/add" method="post">
                <div class="layui-form-item">
                    <label class="layui-form-label">栏目名称</label>
                    <div class="layui-input-block">
                        <input type="text" value="${col}" name="name" required lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">英文名称</label>
                    <div class="layui-input-block">
                        <input type="text" name="Englishname" required lay-verify="required" placeholder="请不要有空格" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
